...
const DaysPage = () => {
  ...
  }, [days, categoryData, preloadAudioBatch, audioInitialized]);
        ...
        <div className="md:flex">
          ...
          <CardContent className="p-4 md:w-2/3 flex flex-col justify-center">
            ...
            {day.audio_url && <div className="mt-3">
                <Button size="sm" variant={isCached(day.audio_url) ? "outline" : "secondary"} className="flex items-center gap-1" onClick={() => handlePlayAudio(day.audio_url, day.id, day)} disabled={playingAudio !== null && playingAudio !== day.id}>
                  {playingAudio === day.id ? <>
